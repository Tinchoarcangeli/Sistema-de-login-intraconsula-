...
<body>
		...
		<h2 align="center">EDITAR CURSADA</h2>
		<form method="post" action='<?php echo site_url('login/saveup_cursadas'); ?>'>
		<table align="center">
		...
		<tr>
			...
			<td>FECHA : </td>
			<td><input type="date" name="txtcarga" value="<?php echo $record->date ?>"/></td>
